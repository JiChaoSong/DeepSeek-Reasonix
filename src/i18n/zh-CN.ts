...
export const zhCN: TranslationSchema = {
  ...
  slash: {
    ...
    feishu: {
      description: "连接、查看或断开当前会话的飞书机器人通道",
  ...
  handlers: {
    ...
    feishu: {
      ...
      connected: "飞书机器人已连接成功，后续启动会自动启用。",
      alreadyConnected: "飞书机器人已连接，自动启动已启用。",
      disconnected: "飞书机器人已断开连接，自动启动已关闭。",
      status:
        "飞书：{connected}，自动启动{enabled}，凭据{configured}，appId {appId}，访问控制 {access}。",
      stateConnected: "已连接",
      stateDisconnected: "未连接",
      stateEnabled: "已启用",
      stateDisabled: "未启用",
      ...
      authFailed: "飞书机器人鉴权失败。",
      readyTimeout: "飞书机器人未在超时前就绪。",
    },
    admin: {
