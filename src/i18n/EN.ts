...
export const EN: TranslationSchema = {
  ...
  slash: {
    ...
    feishu: {
      description: "connect, inspect, or disconnect the Feishu (Lark) bot channel for this session",
  ...
  handlers: {
    ...
    feishu: {
      ...
      connected: "Feishu bot connected. It will auto-start on future launches.",
      alreadyConnected: "Feishu bot is already connected. Auto-start is enabled.",
      disconnected: "Feishu bot disconnected. Auto-start is disabled.",
      status:
        "Feishu: {connected}, auto-start {enabled}, credentials {configured}, appId {appId}, access {access}.",
      stateConnected: "connected",
      stateDisconnected: "disconnected",
      stateEnabled: "enabled",
      stateDisabled: "disabled",
      ...
      authFailed: "Feishu bot authentication failed.",
      readyTimeout: "Feishu bot did not become ready within timeout.",
    },
    admin: {
